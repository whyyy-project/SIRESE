    ...
    <div class="bg-white shadow-lg rounded-lg mt-3 mx-6 pb-5 overflow-hidden">
        <div class="flex justify-between">
            <h1 class="text-2xl font-bold text-gray-800 ml-4 mt-3 text-base md:text-lg">Hasil <span class="text-orange-500"> Rekomendasi</span></h1>
              ...
              <div class="mr-4 mt-4">
              <a href="<?= base_url() ?>rekomendasi" class="text-white bg-orange-500 px-3 text-sm md:text-base py-2 md:px-4 md:py-2 rounded-full hover:bg-orange-400"><i class="fas fa-refresh slow-spin"></i><span class="hidden md:inline"> Atur Ulang</span></a>
                        ...
                        <div class="bg-gray-100 shadow-lg rounded-lg overflow-hidden">
                            <div class="px-4 py-3">
                                ...
                                <div class="flex justify-center items-center mx-auto">
                                    <img loading="lazy" src="<?= base_url() ?>img/smartphone/<?= strlen($data['sGambar']) <= 1 ? 'basic.png' : $data['sGambar'] ?>" class="h-24 w-86 md:h-40 rounded-tr-[20px] rounded-bl-[20px] object-cover" alt="<?= $data['sBrand'] . " " . $data['sMerek'] ?>">
                                </div>
      ...
      <table id="myTable" class="display w-full" style="width:100%">
          <thead class="mt-3 bg-gradient-to-r from-cyan-700 to-gray-800 text-sm shadow text-white">
              <tr class="text-sm">
                  <th>Rank</th>
                  <th>Merek</th>
                  <th id="mobile">Memori</th>
                  <th>Harga</th>
                  <th>Nilai</th>
                  <th id="mobile">Detail</th>
              </tr>
                      </thead>
                  ...
                  <tr class="text-sm">
                      ...
                      <td id="mobile"><?= $data['sRam'] ?>/<?= $data['sRom'] ?>GB</td>
                      <td data-order="<?= $data['sHarga'] ?>">Rp. <?= number_format($data['sHarga'], 0, ',', '.'); ?></td>
                      <td><?= round(($data['total']/$max)*100, 2) ?>%</td>
                      <td id="mobile"><a href="<?= base_url() ?>detail-smarthpone/<?= $data['sSlug'] ?>" class="text-white bg-gray-800 px-3 text-sm md:text-base py-2 md:px-0 md:py-2 rounded-full hover:bg-gray-700 flex justify-center items-center">
