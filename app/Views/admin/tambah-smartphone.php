                ...
                <div class="flex justify-center items-center text-center">
                    ...
                    <div class="relative w-2/3 mx-auto my-4">
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="merek" name="merek" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="merek" oninput="listInput('merek')" onblur="hideDiv('merek')" value="<?= session()->getFlashdata('merek') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="os" name="os" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="os" oninput="listInput('os')" onblur="hideDiv('os')" value="<?= session()->getFlashdata('os') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="cpu" name="cpu" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="cpu" oninput="listInput('cpu')" onblur="hideDiv('cpu')" value="<?= session()->getFlashdata('cpu') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="ram" name="ram" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="ram" oninput="listInput('ram')" onblur="hideDiv('ram')" value="<?= session()->getFlashdata('ram') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="rom" name="rom" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="rom" oninput="listInput('rom')" onblur="hideDiv('rom')" value="<?= session()->getFlashdata('rom') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="main_camera" name="main_camera" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="main_camera" oninput="listInput('main_camera')" onblur="hideDiv('main_camera')" value="<?= session()->getFlashdata('main_camera') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="main_video" name="main_video" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="main_video" oninput="listInput('main_video')" onblur="hideDiv('main_video')" value="<?= session()->getFlashdata('main_video') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="front_video" name="front_video" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="front_video" oninput="listInput('front_video')" onblur="hideDiv('front_video')" value="<?= session()->getFlashdata('front_video') ?>"/>
                        ...
                        <div class="relative w-2/3 mx-auto mb-4">
                            <input required id="usb" name="usb" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="usb" oninput="listInput('usb')" onblur="hideDiv('usb')" value="<?= session()->getFlashdata('usb') ?>"/>
