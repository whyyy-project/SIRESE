            ...
            <div class="px-4 py-3">
              ...
              <?php } ?>
                ...
                <div class="flex justify-center items-center text-center">
                    <form action="<?= base_url() ?>data-toko/update" method="post" class="w-full" enctype="multipart/form-data">
                      <?= csrf_field() ?>
                      <input type="hidden" value="<?= str_replace(' ', '+', $toko['nama_toko'])."-".str_replace(' ', '+', $toko['desa'])."-".str_replace(' ', '+', $toko['kecamatan'])."-" . str_replace(' ', '+', $toko['kota'])  ?>" name="slug">
                      <div class="relative w-2/3 mx-auto my-4">
                            <input required value="<?= set_value('nama_toko', isset($toko['nama_toko']) ? $toko['nama_toko'] : '') ?>" id="nama_toko" name="nama_toko" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="nama_toko"/>
                          ...
                          <div class="relative w-2/3 mx-auto mb-4">
                            <label id="gambar-label" for="gambar" class="block bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700 cursor-pointer flex items-center justify-center">
                                <i class="fas fa-upload mr-2"></i> Upload Gambar (Kosongkan jika tidak diganti)
                            </label>
                      ...
                      <div class="relative w-2/3 mx-auto my-4">
                            <input required value="<?= set_value('desa', isset($toko['desa']) ? $toko['desa'] : '') ?>" id="desa" name="desa" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="desa"/>
                      ...
                      <div class="relative w-2/3 mx-auto my-4">
                            <input required value="<?= set_value('kecamatan', isset($toko['kecamatan']) ? $toko['kecamatan'] : '') ?>" id="kecamatan" name="kecamatan" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="kecamatan"/>
                      ...
                      <div class="relative w-2/3 mx-auto my-4">
                            <input required value="<?= set_value('kota', isset($toko['kota']) ? $toko['kota'] : '') ?>" id="kota" name="kota" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="kota"/>
                      ...
                      <div class="relative w-2/3 mx-auto my-4">
                            <input required value="<?= set_value('provinsi', isset($toko['provinsi']) ? $toko['provinsi'] : '') ?>" id="provinsi" name="provinsi" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="provinsi"/>
                      ...
                      <div class="relative w-2/3 mx-auto my-4">
                            <input required value="<?= set_value('alamat_lengkap', isset($toko['alamat_lengkap']) ? $toko['alamat_lengkap'] : '') ?>" id="alamat_lengkap" name="alamat_lengkap" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="alamat_lengkap"/>
                      ...
                      <div class="relative w-2/3 mx-auto my-4">
                            <input value="<?= set_value('fb', isset($toko['fb']) ? $toko['fb'] : '') ?>" id="fb" name="fb" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="fb"/>
                      ...
                      <div class="relative w-2/3 mx-auto my-4">
                            <input value="<?= set_value('ig', isset($toko['ig']) ? $toko['ig'] : '') ?>" id="ig" name="ig" type="text" class="bg-gray-200 rounded peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-center text-gray-900 text-sm focus:outline-none focus:border-cyan-700" placeholder="ig"/>
